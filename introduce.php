<?php
	/*
	 * page name:introduce.php
	 * author:Ryan Luo
	 * page function:this is the company introduce page action in the eramus website
	...
	function _default()
	{
		...
		if($intScreenX==""||$intScreenY==""){
			...
			echo "<script>location.href='introduce.php';</script>";
		}
		else{
			if($intScreenX==1920&&$intScreenY==1080){	
				$tpl->display("news_bigScreen.html");
			}		
			else{				
